...
(function(exports) {
  ...
  var showSymbolTree = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Model line 24, column 3 - line 24, column 25: " + [ v.constructor.name ]);
  });
  var isForeignTree = function (dictIsForeign) {
      return new Data_Foreign_Class.IsForeign(function (x) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(dictIsForeign)(Data_Foreign_Index.indexString)("name")(x))(function (v) {
              ...
              throw new Error("Failed pattern match at Model line 35, column 5 - line 39, column 90: " + [ $13.constructor.name ]);
          });
      });
  };
  var asForeignTree = function (dictAsForeign) {
      return new Data_Foreign_Class.AsForeign(function (v) {
          ...
          throw new Error("Failed pattern match at Model line 28, column 3 - line 28, column 51: " + [ v.constructor.name ]);
      });
  };
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof ChangeExpression) {
              var $18 = Parsing.parseTreeExpression(v.value0);
              if ($18 instanceof Data_Either.Left) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (v1) {
                      ...
                      $19.errorMessage = Data_Maybe.Just.create(Data_Show.show(Text_Parsing_Parser.showParseError)($18.value0));
                      $19.expression = v.value0;
                      return $19;
                  }))(function () {
              ...
              if ($18 instanceof Data_Either.Right) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (v1) {
                      ...
                      $23.errorMessage = Data_Maybe.Nothing.value;
                      $23.tree = $18.value0;
                      $23.expression = v.value0;
                      return $23;
                  }))(function () {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Control_Monad_Aff_Free.fromEff(Control_Monad_Aff_Free.affableFree(Halogen_Query_HalogenF.affableHalogenF(Control_Monad_Aff_Free.affableAff)))(Render.drawTree(Data_Foreign_Class.write(Model.asForeignTree(Model.asForeignSymbol))($18.value0))))(function () {
                          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value1);
                      });
                  });
              };
              throw new Error("Failed pattern match at UI line 69, column 5 - line 80, column 22: " + [ $18.constructor.name ]);
          };
          if (v instanceof ReduceTree) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (state) {
                  ...
                  $29.expression = Data_Show.show(Model.showSymbolTree)(state.tree);
                  $29.tree = reduceTree(state.tree);
                  return $29;
              }))(function () {
          ...
          throw new Error("Failed pattern match at UI line 68, column 3 - line 80, column 22: " + [ v.constructor.name ]);
      };
