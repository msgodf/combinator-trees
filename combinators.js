          ...
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(dictIsForeign)(Data_Foreign_Index.indexString)("data")(x))(function (v) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("x")(x))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(Data_Foreign_Class.numberIsForeign)(Data_Foreign_Index.indexString)("y")(x))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at D3.Tree line 34, column 5 - line 37, column 77: " + [ $17.constructor.name ]);
                  });
              });
          });
      });
...
(function(exports) {
  ...
  var showSymbol = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Model line 15, column 3 - line 16, column 3: " + [ v.constructor.name ]);
  });
  var showSymbolTree = new Data_Show.Show(function (v) {
      if (v instanceof Leaf) {
          return Data_Show.show(showSymbol)(v.value0);
      };
      if (v instanceof Branch) {
          return "(" + (Data_Show.show(showSymbolTree)(v.value0) + (Data_Show.show(showSymbolTree)(v.value1) + ")"));
      };
      throw new Error("Failed pattern match at Model line 26, column 3 - line 26, column 25: " + [ v.constructor.name ]);
  });
  var isForeignTree = function (dictIsForeign) {
      return new Data_Foreign_Class.IsForeign(function (x) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Foreign_Class.readProp(dictIsForeign)(Data_Foreign_Index.indexString)("name")(x))(function (v) {
              ...
              throw new Error("Failed pattern match at Model line 37, column 5 - line 41, column 90: " + [ $13.constructor.name ]);
          });
      });
  };
  var asForeignTree = function (dictAsForeign) {
      return new Data_Foreign_Class.AsForeign(function (v) {
          ...
          throw new Error("Failed pattern match at Model line 30, column 3 - line 30, column 51: " + [ v.constructor.name ]);
      });
  };
  ...
  exports["showSymbolTree"] = showSymbolTree;
...
(function(exports) {
  ...
  var xyTranslate = function (v) {
      var dy = v.value0.y * 200.0;
      var dx = v.value0.x * 400.0;
      return "translate(" + (Data_Show.show(Data_Show.showNumber)(dx) + ("," + (Data_Show.show(Data_Show.showNumber)(dy) + ")")));
  };
  var radiusBranchesAndLeaves = function (v) {
      ...
      throw new Error("Failed pattern match at Render line 37, column 1 - line 38, column 1: " + [ v.constructor.name ]);
  };
  var drawNodeText = function (parent) {
      return function __do() {
          var v = D3_Selection["append'"](parent)("text")();
          D3_Selection.attr(v)("dy")(new D3_Base.ValString("10px"))();
          D3_Selection.attr(v)("x")(new D3_Base.ValString("24"))();
          D3_Selection.attr(v)("text-anchor")(new D3_Base.ValString("end"))();
          return D3_Selection.text(v)(new D3_Base.ValFn(function (d) {
              return d.data.name;
          }))();
      };
  };
  ...
  var parentChildLink = function (v) {
      return Data_Maybe.maybe("")(diagonal(v))(v.value0.parent);
  };
  var drawLinks = function (links) {
      return function (parent) {
          return function __do() {
              var v = D3_Selection.selectAll(parent)("path.link")();
              var v1 = D3_Selection["data'"](v)(links)();
              var v2 = D3_Selection.enter(v1)();
              var v3 = D3_Selection.insert(v2)(new D3_Base.ValString("path"))("g")();
              var v4 = D3_Selection.attr(v3)("class")(new D3_Base.ValString("link"))();
              D3_Selection.attr(v4)("d")(D3_Base.ValFn.create(function ($64) {
                  return Data_Either.either(Data_Function["const"](""))(parentChildLink)(Control_Monad_Except.runExcept(Data_Foreign_Class.read(D3_Tree.treeNodeDataIsForeign(Model.isForeignTree(Data_Foreign_Class.stringIsForeign)))($64)));
              }))();
              D3_Selection.style(v4)("stroke")(new D3_Base.ValString("#555"))();
              D3_Selection.style(v4)("stroke-width")(new D3_Base.ValString("3px"))();
              return D3_Selection.style(v4)("fill")(new D3_Base.ValString("none"))();
          };
      };
  };
  var colourBranchesAndLeaves = function (v) {
      if (v instanceof LeafNode) {
          return "green";
      };
      if (v instanceof BranchNode) {
      ...
      throw new Error("Failed pattern match at Render line 33, column 1 - line 34, column 1: " + [ v.constructor.name ]);
  };
  var branchOrLeafIsForeign = function (dictIsForeign) {
      return new Data_Foreign_Class.IsForeign(function (x) {
          var $46 = Control_Monad_Except.runExcept(Data_Foreign_Class.readProp(dictIsForeign)(Data_Foreign_Index.indexString)("children")(x));
          if ($46 instanceof Data_Either.Left) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(LeafNode.value);
          };
          if ($46 instanceof Data_Either.Right) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(new BranchNode($46.value0));
          };
          throw new Error("Failed pattern match at Render line 24, column 12 - line 26, column 41: " + [ $46.constructor.name ]);
      });
  };
  var convertToBranchOrLeaf = function ($65) {
      return Control_Monad_Except.runExcept(Data_Foreign_Class.read(branchOrLeafIsForeign(Data_Foreign_Class.arrayIsForeign(branchOrLeafIsForeign(Model.isForeignTree(Data_Foreign_Class.stringIsForeign)))))($65));
  };
  var drawNode = function (parent) {
      return function __do() {
          var v = D3_Selection["append'"](parent)("circle")();
          D3_Selection.attr(v)("class")(new D3_Base.ValString("node"))();
          D3_Selection.attr(v)("r")(D3_Base.ValFn.create(function ($66) {
              return Data_Either.either(Data_Function["const"]("5"))(radiusBranchesAndLeaves)(convertToBranchOrLeaf($66));
          }))();
          D3_Selection.style(v)("fill")(D3_Base.ValFn.create(function ($67) {
              return Data_Either.either(Data_Function["const"]("blue"))(colourBranchesAndLeaves)(convertToBranchOrLeaf($67));
          }))();
          D3_Selection.style(v)("stroke")(new D3_Base.ValString("#555"))();
          return D3_Selection.style(v)("stroke-width")(new D3_Base.ValString("2px"))();
      };
  };
  var drawTree = function (treeData$prime) {
      return function __do() {
          ...
          D3_Selection.attr(v11)("transform")(D3_Base.ValFn.create(function ($68) {
              return Data_Either.either(Data_Function["const"]("translate(0,0)"))(xyTranslate)(Control_Monad_Except.runExcept(Data_Foreign_Class.read(D3_Tree.treeNodeDataIsForeign(Model.isForeignTree(Data_Foreign_Class.stringIsForeign)))($68)));
          }))();
          drawNode(v11)();
          drawNodeText(v11)();
          var $62 = Data_Array.tail(v3);
          if ($62 instanceof Data_Maybe.Nothing) {
              return D3_Selection.rootSelect("")();
          };
          if ($62 instanceof Data_Maybe.Just) {
              return drawLinks($62.value0)(v7)();
          };
          throw new Error("Failed pattern match at Render line 95, column 6 - line 97, column 43: " + [ $62.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var mockingbirdp = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Model.M.value)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("M"));
  var kestrelp = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Model.K.value)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("K"));
  ...
  var symbolp = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(bluebirdp)(kestrelp))(mockingbirdp))(variablep(Text_Parsing_Parser_String.stringLikeString));
...
(function(exports) {
  ...
  var ReduceTree = (function () {
      function ReduceTree(value0) {
          this.value0 = value0;
      };
      ReduceTree.create = function (value0) {
          return new ReduceTree(value0);
      };
      return ReduceTree;
  })();
  var reduceTree = function (v) {
      if (v instanceof Model.Branch && (v.value0 instanceof Model.Branch && (v.value0.value0 instanceof Model.Branch && (v.value0.value0.value0 instanceof Model.Leaf && v.value0.value0.value0.value0 instanceof Model.B)))) {
          return new Model.Branch(v.value0.value0.value1, new Model.Branch(v.value0.value1, v.value1));
      };
      if (v instanceof Model.Branch && (v.value0 instanceof Model.Leaf && v.value0.value0 instanceof Model.M)) {
          return new Model.Branch(v.value1, v.value1);
      };
      if (v instanceof Model.Branch && (v.value0 instanceof Model.Branch && (v.value0.value0 instanceof Model.Leaf && v.value0.value0.value0 instanceof Model.K))) {
          return v.value1;
      };
      if (v instanceof Model.Branch) {
          return new Model.Branch(reduceTree(v.value0), v.value1);
      };
      if (v instanceof Model.Leaf) {
          return new Model.Leaf(v.value0);
      };
      throw new Error("Failed pattern match at UI line 37, column 1 - line 37, column 79: " + [ v.constructor.name ]);
  };
  var ui = (function () {
      var render = function (n) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.div([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("drawing")) ])([  ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Elements_Indexed.input([ Halogen_HTML_Properties_Indexed.inputType(Halogen_HTML_Properties_Indexed.InputText.value), Halogen_HTML_Events_Indexed.onValueInput(Halogen_HTML_Events.input(ChangeExpression.create)), Halogen_HTML_Properties_Indexed.value(n.expression) ]), Halogen_HTML_Elements_Indexed.button([ Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_(ReduceTree.create)) ])([ Halogen_HTML.text("Reduce") ]), Halogen_HTML_Elements_Indexed.p([ Halogen_HTML_Properties_Indexed.class_(Halogen_HTML_Core.className("error")) ])([ Halogen_HTML.text(Data_Maybe.maybe("")(Data_Show.show(Data_Show.showString))(n.errorMessage)) ]) ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof ChangeExpression) {
              var $26 = Parsing.parseTreeExpression(v.value0);
              if ($26 instanceof Data_Either.Left) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (v1) {
                      ...
                      $27.errorMessage = Data_Maybe.Just.create(Data_Show.show(Text_Parsing_Parser.showParseError)($26.value0));
                      $27.expression = v.value0;
                      return $27;
                  }))(function () {
              ...
              if ($26 instanceof Data_Either.Right) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (v1) {
                      ...
                      $31.errorMessage = Data_Maybe.Nothing.value;
                      $31.tree = $26.value0;
                      $31.expression = v.value0;
                      return $31;
                  }))(function () {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Control_Monad_Aff_Free.fromEff(Control_Monad_Aff_Free.affableFree(Halogen_Query_HalogenF.affableHalogenF(Control_Monad_Aff_Free.affableAff)))(Render.drawTree(Data_Foreign_Class.write(Model.asForeignTree(Model.asForeignSymbol))($26.value0))))(function () {
                          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value1);
                      });
                  });
              };
              throw new Error("Failed pattern match at UI line 71, column 5 - line 82, column 22: " + [ $26.constructor.name ]);
          };
          if (v instanceof ReduceTree) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (state) {
                  ...
                  $37.expression = Data_Show.show(Model.showSymbolTree)(state.tree);
                  $37.tree = reduceTree(state.tree);
                  return $37;
              }))(function () {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.get)(function (v1) {
                      return Control_Bind.bind(Control_Monad_Free.freeBind)(Control_Monad_Aff_Free.fromEff(Control_Monad_Aff_Free.affableFree(Halogen_Query_HalogenF.affableHalogenF(Control_Monad_Aff_Free.affableAff)))(Render.drawTree(Data_Foreign_Class.write(Model.asForeignTree(Model.asForeignSymbol))(v1.tree))))(function () {
                          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(v.value0);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at UI line 70, column 3 - line 82, column 22: " + [ v.constructor.name ]);
      };
  ...
  var initialState = {
      ...
      tree: new Model.Leaf(Model.B.value), 
      expression: ""
  };
